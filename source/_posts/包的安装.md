...
>  ![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6f44e51acd9a450f9f88e805e0fe926d~tplv-k3u1fbpfcp-zoom-1.image)
...
> 如果本地安装的包带有 CLI（命令工具），npm 会将它的 CLI 脚本文件放置到```node_modules/.bin```下，使用命令```npx 命令名```即可调用
